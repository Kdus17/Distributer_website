...
const navigate = useNavigate()
  return (
    <footer className="border-gray-300 dark:border-gray-700 bg-gray-100 dark:bg-gray-900 border-t-1 text-gray-900 dark:text-white">
      {/* Main Footer Content */}
          ...
          <div className="text-center lg:text-left">
            ...
            <nav className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-1 gap-3">
              <Link 
                ...
                className="text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white hover:translate-x-2 transition-all duration-300 py-2 group flex items-center justify-center lg:justify-start"
              >
                <span>Home</span>
