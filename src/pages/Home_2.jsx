...
export default function Home_2() {
  return (
    <div>
        {/**Hero */}
        <div className='flex flex-col lg:flex-row w-full p-12 lg:p-24 gap-2 bg-gradient-to-r from-red-50 to-transparent shadow-lg shadow-gray-100'>
            {/**Text With Buttons */}
            <div className='flex flex-col'>
                <h1 className='text-6xl font-bold'>Promoting <br /> Ethiopian</h1>
                <h1 className='text-6xl font-bold text-red-600'>Coffee & Pulses</h1>
                <p className='text-3xl text-gray-500'>Globally</p>
                <br />
                ...
                <div className='flex flex-col md:flex-row gap-6 mt-6'>
                    <button className='flex py-4 rounded-lg px-8 border-1 gap-2 bg-red-600 text-white'>Explore Our Products <ArrowRight/></button>
                    <button className='flex py-4 rounded-lg px-8 border-1 hover:bg-red-600 hover:text-white border-2 border-red-600 text-red-600'>Learn More</button>
                </div>
            </div>

            {/**The Four Figures */}
            <div className='w-full bg-red-600 rounded-3xl rotate-3 my-8 p-8 flex flex-col justify-center items-center gap-2'>
                <div className='bg-white -rotate-3 w-11/12 rounded-3xl flex flex-col gap-6 py-8 px-8'>
        ...
        <div className='w-full px-24 bg-gray-50 flex flex-col items-center py-12 gap-4'>
