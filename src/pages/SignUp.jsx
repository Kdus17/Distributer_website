...
const SignUp = () => {
  ...
  return (
    <div className="min-h-screen flex  justify-center items-center bg-gray-100">
        <div className="flex flex-col w-160 h-160 border border-gray-200 shadow-lg rounded-lg px-12 bg-white  gap-6">
          ...
          <div className="flex flex-col gap-2 text-gray-700">
            ...
            <label htmlFor="email" className="flex has-focus:border-red-500  has-focus:text-red-500 justify-between border-2 border-gray-400 rounded-lg items-center py-2 px-2">
              <TfiEmail />
              <input type="email" name="email" id="email" className=" px-2 w-full caret-red-500  outline-none"
          ...
          <div className="flex flex-col gap-2 text-gray-700">
            ...
            <label htmlFor="confirm_password" className="border-2 border-gray-400 has-focus:border-red-500 has-focus:text-red-500 rounded-lg py-2  px-2 flex justify-between  items-center">
              <RiLockPasswordLine className="text-2xl " />
              <input type={`${see ? "text":"password"}`} name="confirm_password" id="confirm_password" className="w-full font-sans caret-red-500 outline-none  px-2"
          ...
          <div className="flex justify-center mt-6">
            <button className="bg-red-600 w-full p-2 cursor-pointer text-white rounded-md uppercase hover:bg-red-700">Sign Up</button>
          </div>
