...
const Products = () => {
  ...
  return (
   ...
   {/*   Hero  */}
      <div className="flex flex-col gap-2 items-center bg-gradient-to-r from-red-500 to-red-700 w-full py-24 text-white mb-8">
...
{/*  section nav  */}
        <div className='flex flex-col sm:flex-row justify-center gap-4 select-none'>
          <a href="#coffee">
            <div className='group  border border-black/10 shadow-xl py-2 px-8 rounded-lg flex md:gap-4 items-center hover:bg-red-700 hover:text-white  transition-all duration-300 ease-in-out '>
                <Coffee className='group-hover:scale-110 w-8 h-8 transition-all duration-300 ease-in-out'/>
                <p className='text-center max-w-30'> premium coffee</p>
            </div>
          </a>
          <a href="">
            <div className='group bg-white/10 border border-black/10 shadow-xl py-2 px-8 rounded-lg flex md:gap-4 items-center hover:bg-red-700 hover:text-white transition-all duration-300 ease-in-out'>
...
{/* premium Ethiopian coffee  */}
        <section id="coffee" className="flex flex-col items-center gap-4 px-12 py-4 ">
          ...
          {coffeeProducts.map((coffee,key)=>(<div key={key} className="flex flex-col rounded-2xl overflow-hidden max-w-[600px] bg-white mb-2  shadow-lg border border-black/30 pb-4">
          ...
          <div className="flex flex-col items-center gap-4 mt-6 w-full mx-15 bg-white p-8 rounded-2xl ">
            <h1 className="text
            text-3xl font-bold">
          From Bean To Cup Exellence
            </h1>
...
<div className="flex flex-col justify-end gap-4  pr-20 pl-8 pt-6 bg-gradient-to-r from-red-600 to-red-800 rounded-xl  py-4">
...
<div className="grid grid-cols-2 gap-4   p-4">
  <div className=" flex items-start  flex-col bg-gray-400/20 p-4 rounded-lg bg-gradient-to-r from-red-500 to-red-600">
...
Authentic Ethiopian coffee
  ...
  <div className=" flex items-start  flex-col bg-gray-400/20 p-4 rounded-lg bg-gradient-to-r from-red-600 to-red-800">
    <div className=' p-2 rounded-full w-fit bg-black/20 dark:bg-yellow-300/30'>
...
{/* stay updated */}
<div className="flex flex-col  items-center gap-6 w-full  bg-gradient-to-r from-red-600 to-red-700   pt-8  pb-4">
  <h1 className="text-3xl  font-bold">
Stay Updated
  </h1>
 ...
 <input type="email" className="pl-4 py-4 rounded-lg  bg-white w-2/5"  placeholder="enter your email" name="" id="" />
 <button className=" flex justify-around py-4 px-5 gap-1 bg-black/90 w-1/5 text-white rounded-lg">
...
<div className="flex justify-center gap-4">
  <button className="flex justify-around gap-3 px-4 py-4 bg-white rounded-xl border border-gray-300 cursor-pointer hover:bg-red-600 hover:text-white">
